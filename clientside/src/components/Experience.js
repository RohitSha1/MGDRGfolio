                ...
                {experienceData.map((el, index) => {
                  return (
                    ...
                    >
                      ...
                      <Card.Text className='text-right'style={{ fontWeight: 'bold', marginBottom:'1px', marginTop:'6px' }}>{el.exText}</Card.Text>
                      <Card.Text className='text-right'style={{ marginBottom:'1px' }}>{el.exText1}</Card.Text>
                      ...
                      <Card.Img
                        variant='top'
                        style={{ width: '50%', height: '120px', marginTop: 3, borderRadius: '5px',}}
                        src={el.imgsrc}
                      />
                      {/* <Card.Img
                        variant='top'
                      ...
                      {/* <Card.Img
                        variant='top'
                        style={{ width: '30%', height: '100px', marginTop: 13, }}
                        src={el.imgsrc2}
                      /> */}
                      </div>
